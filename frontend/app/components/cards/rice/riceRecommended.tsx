...
export default function RiceRecommended() {
    return (
        <>
            <HStack px="$4" alignItems="center" justifyContent="space-between" mb="$2"> <Text fontSize="$lg" fontWeight="$bold" color="$black">
                Recommended Rice </Text>
                <Text fontSize="$xl" color="$black">→</Text> </HStack>
