...
export default function CalendarScreen() {
    return (
        <Box flex={1} bg="$white" px="$4" py="$6">
            ...
            {/* Back */}
            <Pressable mb="$2">
                <Text fontSize="$md" color="$green600">‹ Back</Text>
            </Pressable>
            ...
            <BaseCard>
                <VStack >
                    ...
                    <HStack justifyContent="space-between" alignItems="center">
                        <Pressable><Text fontSize="$xl">‹</Text></Pressable>

                        <HStack alignItems="center">
                            <Text fontSize="$lg" fontWeight="$semibold">January</Text>
                            ...
                            <Box
                                ...
                                rounded="$md"
                            >
                                <Text fontSize="$md" fontWeight="$bold">2025</Text>
                            </Box>
                        </HStack>
                    ...
                    <HStack justifyContent="space-between" px="$1">
                        {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((d, i) => (
                            <Text key={i} fontSize="$sm" color="$coolGray500">{d}</Text>
                        ))}
                    </HStack>
